...
export const site = {
  ...
  reflections: [
    {
      index: "01",
      title: "招聘的核心不是搜索技巧，而是对「什么样的人能成事」的理解",
      body: "做了这么多年招聘，我越来越觉得，关键词、布尔搜索、渠道技巧这些都是术。真正的道是理解——理解这个岗位到底要解决什么问题，理解什么样的人在什么样的团队里能成事，理解候选人作品背后的思考和潜力。AI 可以帮你把搜索效率提高 10 倍，但如果你的判断本身是错的，效率越高只会越快地找到错的人。",
      tag: "招聘哲学"
    },
    {
      index: "02",
      title: "AI 不应该替代人的判断，而应该把人从机械劳动中解放出来",
      body: "很多人做 AI 招聘工具，目标是「全自动化」——AI 筛选、AI 打分、AI 打招呼，人什么都不用管。但我觉得这是错的。招聘的本质是人和人的连接，AI 可以处理筛选、归档、整理这些机械劳动，但最终判断「这个人合不合适」「怎么打动她」仍然是人。我的所有工具都遵循同一个原则：AI 做机械劳动，人保留判断。关键节点永远留人工确认。",
      tag: "AI 观"
    },
    {
      index: "03",
      title: "效率的复利不在于用了多少工具，而在于有没有把工具沉淀成系统",
      body: "我见过太多人，今天试这个 AI 工具，明天试那个，每个都用几天就放弃了。真正的效率复利来自沉淀——把每一次实验、每一条 Skill、每一个 workflow 都整理好，让它们能被复用、被优化、被持续迭代。我的 AI Workbench 就是这个思路的产物：它不是又一个工具，而是我所有工具的容器，是我自己的 AI 操作系统。",
      tag: "效率思考"
    },
    {
      index: "04",
      title: "美术招聘看的不是简历，是作品，是作品背后的审美和思考",
      body: "普通招聘看学历、看公司、看 title，但美术招聘完全不一样。一个从大厂出来的画师不一定比一个独立画师好，一个有 10 年经验的人不一定比一个 3 年经验的人更适合。美术招聘的核心是看作品——看审美、看完成度、看风格匹配度、看项目经验。这也是为什么我做艺才流的时候，专门花了大量精力处理作品附件的归档和管理，因为对美术招聘来说，作品比简历重要 10 倍。",
      tag: "美术招聘"
    },
    {
      index: "05",
      title: "数据可视化的核心不是图表，而是「谁该看到什么」的视角设计",
      body: "做招聘看板的时候，我一开始也陷入了「图表越多越酷」的误区。但后来发现，同一个招聘漏斗，管理层看趋势、HR 看自己的交付、BP 看部门缺口，每个人要的视角完全不一样。如果给所有人看同一个 dashboard，那等于谁都没看明白。数据可视化的核心不是技术，而是对业务的理解——你得知道每个角色关心什么、需要什么、能做什么决策，然后给他们看刚好够用的数据。",
      tag: "数据思考"
    },
    {
      index: "06",
      title: "AI 的价值不只在效率，也在情绪和陪伴",
      body: "我们总是讨论 AI 怎么提高生产力、怎么替代人，但很少有人讨论 AI 怎么让人更开心。我做软软这个桌宠，纯粹是因为自己想要一个屏幕角落里的小伙伴。技术上很简单，但它是我每天用得最多的 AI 项目——因为它真的在陪伴我。一个会眨眼的小角色、一句随机的鼓励、会前十分钟的温柔提醒，这些东西不能帮你多招一个人，但能让你每天的工作没那么孤单。AI 不该只有效率，也该有温度。",
      tag: "AI 温度"
    }
